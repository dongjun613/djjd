...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/dongge/raw/master/dongge/lzdz1_women.json1')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            '0f38ece139354e3e9b849034d3c6b6fd11',
        ]
    }
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.authorCode = '19c449a9142f4ba5af09c7652da19bcc';

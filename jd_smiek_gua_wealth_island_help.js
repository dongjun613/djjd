...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jxcfd.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jxcfd.json');
    res2 = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jxcfd.json');
    if(!res2[0]) res2 = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jxcfd.json');

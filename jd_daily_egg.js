...
if ($.isNode()) {
  ...
  if (process.env.EGG_FORBID_ACCOUNT) process.env.EGG_FORBID_ACCOUNT.split('&').map((item, index) => Number(item) === 0 ? cookiesArr = [] : cookiesArr.splice(Number(item) - 1 - index, 1))
} else {

...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/ddworld.json111')
    if (!res) {
        $.http.get({url: 'https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/ddworld.json111'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
        await $.wait(1000)
        res = await getAuthorShareCode('https://code.aliyun.com/wudongdefeng/updateteam/raw/master/shareCodes/ddworld.json111')
    }

...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/dongge/raw/master/dongge/lzdz1_huanju11.json1')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'b56485541148443bb2831bf6425645d511',
        ]
    }
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.authorCode = '349c46c8c3464140891ffae5342beafe';

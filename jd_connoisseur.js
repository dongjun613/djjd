...
!(async () => {
    ...
    let res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jd_connoisseur.json')
    if (!res) {
        ...
        await $.wait(1000)
        res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/jd_connoisseur.json')
    }

...
!(async () => {
  ...
  let res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/wish.json')
  if (!res) {
    $.http.get({url: 'http://47.106.222.216:18880/share_code/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/wish.json')
  }

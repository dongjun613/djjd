...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/dongge/raw/master/dongge/lzdz1_huanju2.json1')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'e4bf94e2bfb64e68aec75908af30a95011',
        ]
    }
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.authorCode = '8c58265cc9e54627aab3dc017f9d1ba3';

...
!(async () => {
    ...
    let res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/ttysq.json')
    if (!res) {
        res = await getAuthorShareCode('http://47.106.222.216:18880/share_code/ttysq.json')
    }
    if (res) {

...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `http://120.76.219.92:18880/api/v2/jd/bean/read/${randomCount}/`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {

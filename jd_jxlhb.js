...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '助力逻辑：先自己京东账号相互助力，如有剩余助力机会，则助力作者\n' +
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  let res = await getAuthorShareCode('http://120.76.219.92:18880/share_code/jxhb.json') || [];
...
function taskurl(_0x3805df, _0x1ebb69 = '', _0x1a9706) {
  ...
  let _0x3d5b0d = BASE_URL + '/' + _0x3805df + '?activeId=489177&publishFlag=1&channel=7&' + _0x1ebb69 + '&sceneval=2&g_login_type=1×tamp=' + Date['now']() + '&_=' + (Date['now']() + 0x2) + '&_ste=1';

...
!(async () => {
  var _0xb477a4 = {
    ...
    'GiWZg': 'http://120.76.219.92:18880/share_code/jxhb.json',
    'CJOxf': 'http://120.76.219.92:18880/share_code/jxhb.json',
    'SrNDE': '2|5|0|3|4|1',
...
function getAuthorShareCode(_0x233ee7 = 'http://120.76.219.92:18880/share_code/jxhb.json') {
  var _0x31492b = {
...
function taskurl(_0x5c376d, _0x5cfc5a = '', _0xd225c6) {
  ...
  let _0x3ff6db = BASE_URL + '/' + _0x5c376d + '?activeId=489177&publishFlag=1&channel=7&' + _0x5cfc5a + '&sceneval=2&g_login_type=1×tamp=' + Date['now']() + '&_=' + _0x4804a7['yKmpn'](Date['now'](), 0x2) + '&_ste=1';
